...
self.addEventListener('fetch', (event) => {
  ...
  // Strategy A: HTML Navigation (SPA routes like /menu, /deals, /cart)
  ...
  // Strategy B: API Calls (Menu, Deals, Categories)
  ...
  // Strategy C: Static Assets (JS, CSS, Images, Fonts)
  // Stale-While-Revalidate (Fast load from cache, then update cache)
  event.respondWith(
