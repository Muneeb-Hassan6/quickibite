  ...
  const fetchData = async () => {
    ...
    try {
      ...
      try {
        ...
        console.error("Backend returned non-JSON response for addon_groups.php:", mapsRaw);
      }

      if (mapsData && mapsData.status === "success" && Array.isArray(mapsData.category_addons)) {
      ...
      try {
        ...
        console.error("Backend returned non-JSON response for get_categories.php:", catRaw);
      }
