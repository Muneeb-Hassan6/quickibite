...
export function getCustomerAppUrl() {
  ...
  // If running on dev port 5174, swap to 5173 for customer
 ...
 * Priority: VITE_STAFF_URL env → window.location.origin
 */
